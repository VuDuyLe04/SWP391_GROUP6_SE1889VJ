            ...
            <div class="row">
                <div class="col-md-12">
                    <section class="panel panel-featured panel-featured-primary">
                        <form:form id="add-form" action="/createstore" method="post" modelAttribute="StoreDTO">
...
<script>
    ...
    document.getElementById("submitBtn").addEventListener("click", function(event) {
        ...
        if (name === "") {
            document.getElementById("nameError").innerText = "Vui lòng nhập tên cửa hàng! ";
            document.getElementById("nameError").style.display = "block";
            isValid = false;
        }
        if (address === "") {
            document.getElementById("addressError").innerText = "Vui lòng nhập địa chỉ của cửa hàng! ";
