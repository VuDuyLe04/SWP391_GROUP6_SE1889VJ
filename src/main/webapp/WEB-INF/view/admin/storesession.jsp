            ...
            <div class="panel-body">
                <form action="index.html">
                    <div class="current-user text-center">
                        <img src="/client/auth/assets/images/!logged-user.jpg" alt="John Doe" class="img-circle user-image" />
                        <h2 class="user-name text-dark m-none">${sessionScope.user.name}</h2>
                        <p class="user-email m-none">${sessionScope.user.role.name}</p>
                    </div>
