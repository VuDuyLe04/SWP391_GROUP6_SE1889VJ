...
<head>
    ...
    <title>Danh sách quy cách đóng gói</title>
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-bordered table-striped table-hover mb-none">
                                    ...
                                    <tr>
                                        ...
                                        <th><i class="fa fa-check-circle mr-xs"></i>Số lượng 1 gói</th>
...
<%--                                                    <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" />--%>
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="quantityPerPackage-${u.id}">Số lượng 1 gói:</label>
                                                            <form:input type="number" path="quantityPerPackage" class="form-control" id="quantityPerPackage-${u.id}" name="quantityPerPackage" value="${u.quantityPerPackage}" />
                                                        </div>
