                                ...
                                <table class="table table-bordered table-striped table-hover mb-none">
                                    ...
                                    <c:forEach var="bill" items="${bills}" varStatus="status">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">${bill.createdAt}</td>
                                            <td class="text-center">${bill.inDebt}</td>
                                            <td class="text-center">${bill.totalBillPrice}</td>
                                            ...
                                            <td class="text-center">${bill.totalLiftPrice}</td>
                                            <td class="text-center">
