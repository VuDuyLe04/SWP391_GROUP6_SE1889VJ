    ...
    <div class="inner-wrapper">
        ...
        <section role="main" class="content-body">
            <header class="page-header">
                <h2><i class="fa fa-users mr-xs"></i> Lịch sử thuê dịch vụ   </h2>
            ...
            <div class="controls-section">
                ...
                <div class="filter-form">
                    <form id="dateForm" action="/owner/service/history" method="get">
                ...
                <div class="search-box">
                    <form id="search-form" action="/owner/service/history" method="get" class="search-form">
                        ...
                        <table class="table">
                            ...
                            <c:forEach var="transaction" items="${transactions.content}" varStatus="status">
                                <tr>
                                    ...
                                    <td>${transaction.durationMonths}</td><!-- Số tiền -->
                    ...
                    <div class="pagination-section">
                        ...
                        <ul class="pagination">
                            <li class="page-item ${c==0 ?'disabled':''}">
                                <a class="page-link" href="/owner/service/history?page=${c==0 ? 0 : (c - 1)}&input=${input}&startDate=${startDate}&endDate=${endDate}&minAmount=${minAmount}&maxAmount=${maxAmount}&status=${status}">Trước</a>
                            </li>

                            <c:forEach begin="0" end="${transactions.totalPages - 1}" var="i">
                                <c:if test="${i >= c - 1 && i <= c + 1}">
                                    <li class="page-item ${c == i ? 'active' : ''}">
                                        <a class="page-link" href="/owner/service/history?page=${i}&input=${input != null ? input : ''}&startDate=${startDate}&endDate=${endDate}&minAmount=${minAmount}&maxAmount=${maxAmount}&status=${status}">${i + 1}</a>
                                    </li>
                                </c:if>
                            ...
                            <li class="page-item ${c == transactions.totalPages - 1 ? 'disabled' : ''}">
                                <a class="page-link" href="/owner/service/history?page=${c == transactions.totalPages - 1 ? transactions.totalPages - 1 : (c + 1)}&input=${input}&startDate=${startDate}&endDate=${endDate}&minAmount=${minAmount}&maxAmount=${maxAmount}&status=${status}">Sau</a>
                            </li>
                        </ul>
                    </div>
                </c:if>
